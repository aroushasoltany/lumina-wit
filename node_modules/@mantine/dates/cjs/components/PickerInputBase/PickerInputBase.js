...
const PickerInputBase = React.forwardRef((props, ref) => {
  ...
  return /* @__PURE__ */ React__default.createElement(React__default.Fragment, null, dropdownType === "modal" && !readOnly && /* @__PURE__ */ React__default.createElement(core.Modal, __spreadValues({
    ...
    returnFocus: true,
    unstyled
  }, popoverProps), /* @__PURE__ */ React__default.createElement(core.Popover.Target, {
    shouldOverrideDefaultTargetId: !hasLabel
  }, /* @__PURE__ */ React__default.createElement(core.Input, __spreadValues(__spreadProps(__spreadValues({
